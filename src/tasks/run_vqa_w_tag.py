...
from src.datasets.dataset_vqa import ClipBertVQATagDataset, VQATagCollator
...
def mk_vqa_dataloader(anno_path, img_lmdb_dir, cfg, tokenizer, is_train=True):
    ...
    dataset = ClipBertVQATagDataset(datalist=group_datalist,
                                 tokenizer=tokenizer,
    ...
    sampler = DistributedSampler(
        ...
        shuffle=is_train)
    vqa_collator = VQATagCollator(tokenizer=tokenizer,
